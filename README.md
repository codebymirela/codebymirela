...
Sou apaixonada por tecnologia e automação, com foco especial em arquitetura de nuvem e cultura DevOps. Atualmente, estou em uma jornada intensa de estudos para conquistar as certificações **AWS (Associate & Security Specialty)**. Meu objetivo é construir infraestruturas resilientes e escaláveis, dominando linguagens como **Python, Go e Java**. Além do código, sou uma entusiasta do **Linux** e de ferramentas que facilitam a jornada do desenvolvedor.

<p align="left">
    <a href="https://github.com/codebymirela?tab=repositories&sort=stargazers">
        <img 
